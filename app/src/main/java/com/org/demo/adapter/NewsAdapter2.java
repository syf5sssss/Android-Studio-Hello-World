...
import com.org.demo.entity.News;
        ...
        if (convertView == null) {
            switch (type) {
                case TYPE_NEWS_1:
                    ...
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_listview_item
                            , parent
                            , false);
                ...
                case TYPE_NEWS_2:
                    ...
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_listview_item2
                            , parent
                            , false);
